...
class ChannelMessage(DiscordObject):
    ...
    Attributes:
        ...
        mention_roles (:obj:`list` of :class:`discordaio.role.Role`): object ids roles specifically mentioned in this message
        attachments (:obj:`list` of :class:`discordaio.attachment.Attachment`): objects any attached files
        embeds (:obj:`list` of :class:`discordaio.embed.Embed`): objects any embedded content
        reactions (:obj:`list` of :class:`discordaio.reaction.Reaction`): objects reactions to the message
