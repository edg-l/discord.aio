...
class Reaction(DiscordObject):
    ...
    Attributes:
        ...
        emoji (:class:`discordaio.emoji.Emoji`): emoji information
    """
...
class ChannelMessage(DiscordObject):
    ...
    Note:
        The author object follows the structure of the :class:`discordaio.user.User` object, but is only a valid user in the case where the message is generated by a user or bot user.
        If the message is generated by a :class:`discordaio.webhook.Webhook`, the author object corresponds to the webhook's id, username, and avatar.
    ...
    Attributes:
        ...
        mentions (:obj:`list` of :class:`discordaio.user.User`): objects users specifically mentioned in the message
        mention_roles (:obj:`list` of :class:`.Role`): object ids roles specifically mentioned in this message
        attachments (:obj:`list` of :class:`discordaio.channel.Attachment`): objects any attached files
        embeds (:obj:`list` of :class:`discordaio.channel.Embed`): objects any embedded content
        reactions (:obj:`list` of :class:`discordaio.channel.Reaction`): objects reactions to the message
